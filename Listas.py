...
Listas em Python funcionam como veotres/matrizes (arrays) em outras linguagens, com a diferença
de serem DINÂMICOS e também de podermos colocar QUALQUER tipo de dado.

---------------- C ou Java (Arrays) ----------------------
    - Possuem tamanho e tipo de dado fixo:
    ou seja, nessas liguagens se você criar um array do tipo int e com tamanho 5, este array
    será SEMPRE do tipo inteiro e poderá ter SEMPRE no máximo 5 valores.

------------------ Python --------------------
- Dinâmico: Não possue tamanho fixo; Ou seja, podemos criar a lista e simplesmente ir adicionando  elemento;
- Qualquer tipo de dado: as listas Não possuem tipo de dado fixo: Ou seja, poremos colocar qualquer tipo de dado;

As listas em python sõa reperesentadas por colchetes: []
...
num = int(input('degite o numero que deseja procurar '))
if num in lista4:
...
+++++Para adicionar elementos em listas utilizamos a funçao append
...
# OBS: Isso não substitui o valor inicial. O mesmo será deslicado para a direita da lista.
...
------------------------------------------------------------------------------
# Podemos remover facilemente o último elemento de uma lista
...
# OBS: Os elementos á direita deste índice serão deslocados para a esqueda.
...
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 3], 124314252]
print(lista6)
print(type(lista6))
...
produto = ''
while produto != 'sair':
    print('Adicione um produto na lista ou digite "sair" para sair: ')           #LOOOP
    produto = input()
    if produto != 'sair':
        carrinho.append(produto)
for produto in carrinho:                                                  #PARA
    print(produto)
...
# Fazer acesso aos elemnetos de forma indexada inversa
...
while indice < len(cores):
    print(cores[indice])
    indice = indice + 1  # Conta assim: -3, -2, -1, 0, 1, 2, 3.
...
# print(numeros.index(91)) # Gera ValueError
...
# OBS: Caso não tenha este elemento na lista, será apresentado VelueError
...
lista = [1, 2, 3, 4,]
print(lista[1:]) # Inicio no índice 1 e pegando todos os elementos restantes  (' : ')

# Trabalhando com slice de lista com o parâmetro 'fim'
print(lista[:2]) # Começa em 0, pega até o índice 2 - 1 ( 0, 1.)

print(lista[:4]) # Começa em 0, pega até o índice 4 - 1 ( 0, 1, 2, 3.)
...
# Isso em Python é chamado de ( Shalow Copy ).
"""
